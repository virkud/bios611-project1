...
#Create all_dem.csv
sim_all_dem <- data.frame(subject_id, gender[1:11981], anchor_age=anchor_age1[1:11981])
write_csv(sim_all_dem, "derived_data/sim_all_dem.csv")
#Create hf_dem.csv
sim_hf_dem <- data.frame(subject_id, gender[1:11981], anchor_age=anchor_age2, language[1:11981], 
           marital_status[1:11981], ethnicity[1:11981])
write_csv(sim_hf_dem, "derived_data/sim_hf_dem.csv")
#Create hf_pred.csv
sim_hf_pred <- data.frame(subject_id, gender[1:11981], anchor_age=anchor_age2, language[1:11981], marital_status[1:11981], ethnicity[1:11981], Aspirin, Statin,
