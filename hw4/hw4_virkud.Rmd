...
## Datasetup
```{r, include=FALSE}
data <- read_csv("~/bios611-project1/hw4/source_data/kaggle.csv")
...
This indicates that this model performs slightly better than random guessing.
